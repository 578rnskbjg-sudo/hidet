...
def gemm_multi_buffer(m, n, k):
    ...
    # m % block_m == 0 and n % block_n == 0
    # 16x32
    a = TensorLayout(((4, 8, 2), (2, 2, 2)), ((32, 1, 256), (16, 8, 128)))
    # 8x32
    b = TensorLayout(((4, 8, 2), (2, 2)), ((16, 1, 128), (8, 64)))
    c = TensorLayout(((4, 8, 2), (2, 2)), ((32, 1, 0), (16, 8)))
    ...
    with hidet.script_module() as script_module:
        ...
        def func(a: f16[m, k], b: f16[k, n], c: f16[m, n]):
            ...
            tr_c_f16 = arithmetic(tr_c_fin, op=convert)
...
if __name__ == "__main__":
    test_gemm_multi_buffer(gemm_multi_buffer, 4096, 4096, 4096)
