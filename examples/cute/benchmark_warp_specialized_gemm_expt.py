...
class WarpSpecializedGemm:
    ...
    def _candidates(self, cluster_m, cluster_n, tiled_mma: TiledMma, k_pipe_max, bk):
        ...
        num_waves = cdiv(grid_size, num_sms)
        ...
        with hidet.script_module() as script_module:
            ...
            def func(a: f16[m, k], b_ptr: ~f16, c: f16[m, n]):
                ...
                attrs.cuda.grid_dim = num_sms, 1, 1  # Grid dimensions based on matrix size
...
if __name__ == "__main__":
    ...
    weight_shapes = [[6144, 4096], [4096, 14336], [14336, 4096], [4096, 4096], [10240, 8192], [8192, 28672], [8192, 8192], [28672, 8192]]
